...
(add-hook 'org-mode-hook
          '(lambda ()
             ...
             (define-key org-mode-map "\M-f" 'org-metaright)
             (define-key org-mode-map "\M-b" 'org-metaleft)
             (define-key org-mode-map "\M-p" 'org-metaup)
             (define-key org-mode-map "\M-n" 'org-metadown)
             (define-key org-mode-map "\S-\M-f" 'org-shiftmetaright)
             (define-key org-mode-map "\S-\M-b" 'org-shiftmetaleft)
             (define-key org-mode-map "\S-\M-p" 'org-shiftmetaup)
             (define-key org-mode-map "\S-\M-n" 'org-shiftmetadown)
             (set-face-foreground 'org-level-1 "DeepSkyBlue")
             (set-face-foreground 'org-level-2 "MediumBlue")
             (set-face-foreground 'org-level-3 "DodgerBlue")
             (set-face-foreground 'org-level-4 "SlateBlue")
             (set-face-foreground 'org-level-5 "LightSeaGreen")
             (set-face-foreground 'org-level-6 "DarkGreen")
             (set-face-foreground 'org-level-7 "gray40")
